        ...
        return(
            ...
            <ListGroup.Item>
                <Container className="match-container">
                    <img  alt="match-shield" src="https://as00.epimg.net/img/comunes/fotos/fichas/equipos/large/72.png" className="shield-img"></img>
    ...
    render() {
        return(
             ...
             <tr>
                 ...
                 <td className="shield-col-group"><img alt="match-shield" className="table-shield" src="https://as00.epimg.net/img/comunes/fotos/fichas/equipos/large/72.png"></img></td>
